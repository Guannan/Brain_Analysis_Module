...
/**
 * Creates a tab that allows a current database administrator to add a new user
 * that can access the database
 * 
 * @author rachelcoston
 *
 */
public class AddUserTab extends JComponent {
	 ...
	 *            The model
	 */
	public AddUserTab(final JFrame parent, final DatabaseAdminModel model) {
		super();
		lbUsername = new JLabel("Enter the user's new username: ");

		username = new JTextField(20);

		lbPassword = new JLabel("Enter the user's new password: ");
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (model.userValid(getUsername(), getPassword())) {
					JOptionPane.showMessageDialog(parent,
							"User Successfully Created", "OK",
					...
					JOptionPane.showMessageDialog(parent, "The username "
							+ getUsername() + " is not available", "OK",
